...
<body class="text-center">
  <form class="form-signin" action="login.php" method="post">
    <img class="mb-4" src="./icone_infor.svg" alt="" width="100" height="100">
    ...
    <h1 class="h3 mb-3 font-weight-normal">Loja de Informática Controle de Estoque</h1>
    ...
    <p class="mt-5 mb-3 text-muted" id="copy"> Login: admin Senha: admin </br> &copy;Projeto Final - FIC - IFPA</p>
  </form>
</body>
</html>
