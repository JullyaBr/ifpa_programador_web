...
<body>
  ...
  <nav class="navbar navbar-dark fixed-top bg-dark flex-md-nowrap p-0 shadow">
    <a class="navbar-brand col-sm-3 col-md-2 mr-0" href="../index.php">Loja Informática</a>
      ...
      <nav class="col-md-2 d-none d-md-block bg-light sidebar">
        <div class="sidebar-sticky">
          <ul class="nav flex-column">
            ...
            <li class="nav-item">
              <a class="nav-link"
              href="<?= BASE_URL.'cliente/crud_cliente.php?acao=listar';?>">
            ...
            <li class="nav-item">
              <a class="nav-link"
              href="<?= BASE_URL.'laptop/crud_laptop.php?acao=listar';?>">
            ...
            <li class="nav-item">
              <a class="nav-link"
              href="<?= BASE_URL.'impressora/crud_impressora.php?acao=listar';?>">
